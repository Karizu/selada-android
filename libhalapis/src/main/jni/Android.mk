...
include $(CLEAR_VARS)
LOCAL_MODULE := jni_cloudpos_clonescreen
LOCAL_SRC_FILES += hal_sys_log.c
LOCAL_SRC_FILES += clonescreen/clone_screen_jni_register.cpp
LOCAL_SRC_FILES += clonescreen/clone_screen_jni_interface.cpp
LOCAL_LDLIBS    := -llog
include $(BUILD_SHARED_LIBRARY)

include $(CLEAR_VARS)
LOCAL_MODULE := jni_cloudpos_battery
LOCAL_SRC_FILES += hal_sys_log.c
LOCAL_SRC_FILES += battery/battery_jni_register.cpp
LOCAL_SRC_FILES += battery/battery_jni_interface.cpp
LOCAL_LDLIBS    := -llog
include $(BUILD_SHARED_LIBRARY)

#include $(CLEAR_VARS)
#LOCAL_MODULE := jni_cloudpos_hsm
#LOCAL_SRC_FILES += hal_sys_log.c
#LOCAL_SRC_FILES += hsm/jni_register.cpp
#LOCAL_SRC_FILES += hsm/osm_jni_interface.cpp
#LOCAL_LDLIBS    := -llog
#include $(BUILD_SHARED_LIBRARY)


include $(CLEAR_VARS)
LOCAL_MODULE := jni_cloudpos_emv
LOCAL_SRC_FILES += hal_sys_log.c
LOCAL_SRC_FILES += emv/jni_register.cpp
LOCAL_SRC_FILES += emv/emv_kernal_jni_interface.cpp
LOCAL_LDLIBS    := -llog
include $(BUILD_SHARED_LIBRARY)

...
import com.cloudpos.jniinterface.PrinterInterfaces;
...
public class PrinterAction extends ConstantAction {
    ...
    public void queryVoltage(Map<String, Object> param, ActionCallbackImpl callback) {
        ...
        int result = getData(new DataAction() {
            ...
            public int getResult() {
                ...
                int result = PrinterInterfaces.queryVoltage(pCapacity, pVoltage);
                return result;
            }
        });
        if (result >= 0) {
    ...
    public void open(Map<String, Object> param, ActionCallbackImpl callback) {
        ...
        if (isOpened) {
            ...
            try {
                int result = PrinterInterfaces.open();
                if (result < 0) {
    ...
    public void close(Map<String, Object> param, ActionCallbackImpl callback) {
        ...
        checkOpenedAndGetData(new DataAction() {
            ...
            public int getResult() {
                isOpened = false;
                int result = PrinterInterfaces.close();
                return result;
            }
        });
    }
    ...
    public void queryStatus(Map<String, Object> param, ActionCallbackImpl callback) {
        ...
        checkOpenedAndGetData(new DataAction() {
            ...
            @Override
            public int getResult() {
                int result = PrinterInterfaces.queryStatus();
                if (result > 0) {
                    // has paper
    ...
    private void begin() {
        checkOpenedAndGetData(new DataAction() {
            ...
            @Override
            public int getResult() {
                int result = PrinterInterfaces.begin();
                return result;
            }
        });
    }
    ...
    private void end() {
        checkOpenedAndGetData(new DataAction() {
            ...
            @Override
            public int getResult() {
                int result = PrinterInterfaces.end();
                return result;
            }
        });
    }
    ...
    private void write(final byte[] arryData) {
        checkOpenedAndGetData(new DataAction() {
            ...
            public int getResult() {
                int result = 0;
                if (arryData == null) {
                    result = PrinterInterfaces.write(null, 0);
                } else {
                    ...
                    // arryData.length);
                    // result = PrinterInterfaces.write(testData, 10,
                    // arryData.length);
                    result = PrinterInterfaces.write(arryData, arryData.length);
                }
                return result;
            }
        });

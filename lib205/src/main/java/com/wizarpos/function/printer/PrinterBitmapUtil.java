...
public class PrinterBitmapUtil {
    ...
    private static void printBitmapDV2VMSB(Bitmap bm, int bitMarginLeft, int bitMarginTop) {
        ...
        // PrinterInterfaces.PrinterWrite(new byte[]{0x1B, 0x37,
        // 7,(byte)240,2},5);
        ...
        // PrinterInterfaces.PrinterWrite(titles,titles.length);
        // }
    ...
    public static void printBitmapGSVMSB(Bitmap bm, int bitMarginLeft, int bitMarginTop) {
        ...
        //PrinterInterfaces.PrinterWrite(PrinterCommand.getCmdEscDN(2), PrinterCommand.getCmdEscDN(2).length);

...
import com.boardinglabs.mireta.selada.component.util.DateHelper;
        ...
        httpClient.addInterceptor(new Interceptor() {
            ...
            public Response intercept(Chain chain) throws IOException {
                ...
                if (TextUtils.isEmpty(input)) {
                    input = chain.request().url().toString().replace(com.boardinglabs.mireta.selada.component.network.BuildConfig.LOKAL_URL, "");
                } else if (chain.request().url().toString().equals(com.boardinglabs.mireta.selada.component.network.BuildConfig.LOKAL_URL + "/uploads/image")) {
...
//                Log.i("kunaminput", input);
        ...
        retrofit = new Retrofit.Builder()
                .baseUrl(com.boardinglabs.mireta.selada.component.network.BuildConfig.LOKAL_URL)
    ...
    public static synchronized NetworkService getSeladaCoreInstance(){
        instance = null;
        final String sessionToken = PreferenceManager.getSessionToken();
...
//                Log.i("kunaminput", input);
        ...
        retrofit = new Retrofit.Builder()
                .baseUrl(com.boardinglabs.mireta.selada.component.network.BuildConfig.SELADA_CORE_URL)
                .addConverterFactory(GsonConverterFactory.create(gson))
                .addCallAdapterFactory(RxJavaCallAdapterFactory.create())
                .client(httpClient.build())
                .build();

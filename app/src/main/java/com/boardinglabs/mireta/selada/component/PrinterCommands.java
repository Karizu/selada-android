package com.boardinglabs.mireta.selada.component;
...
public class PrinterCommands {
    ...
    public static final byte[] INIT = {27, 30};
    ...
    public static final byte[] ESC_ENTER = new byte[] { 0x1b,0x21,0x01 };
    public static final byte[] ESC_BOLD = new byte[] { 0x1b,0x21,0x01 };
